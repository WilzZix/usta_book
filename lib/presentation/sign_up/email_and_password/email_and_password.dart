      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 36),
            InputField.email(fieldTitle: tr.input_field.email_field, controller: emailController),
            SizedBox(height: 8),
            InputField.password(fieldTitle: tr.input_field.password_field, controller: passwordController),
            SizedBox(height: 36),
